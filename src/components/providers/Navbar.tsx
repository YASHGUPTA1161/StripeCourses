...
// Or, if the file does not exist, create 'src/components/ui/button.tsx' with your Button component.
			...
			<div className='flex items-center space-x-1 sm:space-x-4'>
				...
				<SignedOut>
					<SignUpButton mode='modal'>
						<Button variant='outline' size='sm' className='text-black border-black'>Sign Up</Button>
					</SignUpButton>
				</SignedOut>
			</div>
		</nav>
